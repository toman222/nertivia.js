...
import {default as MessageButtonInterface} from './Interfaces/MessageButton'
export namespace Interfaces {
  export type MessageButton = MessageButtonInterface
}
...
function addServerMember (member: any, client: Client) {
  const guild = client.guilds.cache.get(member.server_id)
  if (guild !== undefined) {
...
const events = {
  ...
  message_button_clicked: (data: any, _client: Client) => {
